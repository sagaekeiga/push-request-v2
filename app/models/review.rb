...
class Review < ApplicationRecord
  ...
  def reflect!
    ActiveRecord::Base.transaction do
      ...
      response = Github.receive_api_request_in_json_format_on "https://api.github.com/repos/#{pull.repo_full_name}/pulls/#{pull.number}/reviews", json_format_request_body, pull.repo.installation_id
