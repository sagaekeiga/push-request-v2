...
class ChangedFile < ApplicationRecord
  ...
  def self.create_or_restore!(pull)
    ActiveRecord::Base.transaction do
      response_changed_files_in_json_format = Github::Response.receive_api_response_in_json_format_on "https://api.github.com/repos/#{pull.repo_full_name}/pulls/#{pull.number}/files", pull.repo.installation_id
